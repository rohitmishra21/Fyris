...
const Boxes = ({ left, isBoxRightSide, imgSrc, heading, count }) => {
    return left ? (
        <div className=" ml-8 mr-2 flex flex-col items-center justify-between bg-black border-2 md:border border-zinc-300 rounded-2xl w-16 h-[270px] md:h-[350px] p-4">
        ...
        <div className={`w-[265px] relative h-[130px] md:h-[170px] md:w-[300px] flex justify-between  px-5  gap-3  ${isBoxRightSide ? ' flex-row-reverse' : 'flex - row'} p-2 mb-2 rounded-2xl md:border border-2 border-zinc-300`}>
