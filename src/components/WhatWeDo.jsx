...
const WhatWeDo = () => {
    return (
        <div className=''>  <h1 className='text-3xl relative bruno-ace mt-16 tracking-[2px] md:text-start md:text-7xl p-6 text-center'>What we <span className='bg-gradient-to-r from-[#00AAF2] to-[#90759d] bg-clip-text text-transparent'>do</span></h1>

            <h2 className='text-center mt-3 text-xs md:text-2xl '>Design. Technology. Marketing</h2>
            <div className='flex md:block '>
                <div className='absolute'>
                    <img className='lg:w-96 md:w-54 lg:mt-0 md:mt-10' src="bgColor.svg" alt="" />
