            ...
            <div className='md:flex '>
                <div className=' mt-8 md:w-1/2 lg:text-end  '>
                    <div className='   lg:font-medium'>
                        <h1 className='px-8 leading-10 lg:mr-10'>
                            <span className='text-xl  lg:text-3xl'>We</span>
                            <span className='text-2xl lg:text-4xl  px-2'>Create</span>
                        ...
                        <h1 className='pl-14 absolute lg:static '>
                            <span className='text-xl lg:text-3xl'>That</span>
                            <span className='text-4xl lg:text-6xl  px-2'>Solve</span>
                            <span className='text-xl lg:text-3xl'>Your</span>
                            <span className='text-4xl lg:text-6xl px-2'>Problem.</span>
                        </h1>
                    </div>
